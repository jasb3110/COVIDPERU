...
After that data include date since 6/06/2020 to 21/02/2022(Column 1), COVID positive rate (Column 2), COVID death index which estimated of excess historical (SINADEF-column 6), free UCI bed in percent(Column 10) and vaccinated people which have 1 to 5 doses (Column 12 to 16). to see https://github.com/jasb3110/COVIDPERU/blame/To-introduce-COVID-19-project/data.csv .
