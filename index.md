...
Therefore, the first challenge was delete or omit different mistakes (Na, null values and outliers). whole of data were downloaded of Peruvian official sources,"datos abiertos" [(3)]](#references). I would show you how to manage deep cleaning the data.
