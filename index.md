...
Therefore, the first challenge was delete or omit different mistakes (Na, null values and outliers). whole of data were downloaded of Peruvian official sources [datosabiertos](https://www.datosabiertos.gob.pe/). I would show you how to manage deep cleaning the data.
...
2. [Noticia](https://larepublica.pe/sociedad/2020/04/13/coronavirus-en-peru-testimonio-del-paciente-cero-tras-su-recuperacion-mdga/)
