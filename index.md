...
Therefore, the first challenge was delete or omit different mistakes (Na, null values and outliers). whole of data were downloaded of Peruvian official sources,[datosabiertos](https://www.datosabiertos.gob.pe/search/type/dataset)  [(3)](#references). I would show you how to manage deep cleaning the data.
...
[Contact Us](mailto:solisbenites.jose@gmail.com) here, if you consider to give opinions, suggestions and questions. 
